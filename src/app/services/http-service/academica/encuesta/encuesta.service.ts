...
export class EncuestaService {
  ...
  constructor(public http:HttpClient) {
   ...
   getPlanesPromedio(registro: object) {
    return new Promise((resolve, reject) => {
      this.http.post(this.url+'academica/encuesta/getPlanesPromedio',{}, this.httpHeaders)
      .subscribe(data => {
          resolve(data)
      })
    })
  ...
  getReportePromedioMaterias(registro: object) {
    return new Promise((resolve, reject) => {
      this.http.post(this.url+'academica/encuesta/getReportePromedioMaterias', registro, this.httpHeaders)
      .subscribe(data => {
          resolve(data)
      })
    })
  ...
  getPromedioMateriasEncuestas(registro: object) {
    return new Promise((resolve, reject) => {
      this.http.post(this.url+'academica/encuesta/getPromedioMateriasEncuestas', registro, this.httpHeaders)
      .subscribe(data => {
          resolve(data)
      })
    })
